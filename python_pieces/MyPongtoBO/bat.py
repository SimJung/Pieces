...
class Bat:
    ...
    #### 메서드
    def detect_collision(self, ball, sides_sweet_spot=False, topnbottom_sweet_spot=True):
        collision_direction = ""
        collision = False
        feel = 5
        # 배트 변수:
        ...
        if(collision):
            ...
            if((sides_sweet_spot == True) and (collision_direction == "W" or collision_direction == "E")):
                ...
                ball.y_speed = feel * adjustment * 2
                ball.x_speed = 10 + (10 - ball.y_speed)*0.7
            ...
            if((topnbottom_sweet_spot == True) and (collision_direction == "N" or collision_direction == "S")):
                ...
                ball.x_speed = feel * adjustment * 2
                ball.y_speed = -10 - (10 - abs(ball.x_speed)) * 0.7
